# njk-blog
Dette er en hjemmeside, der laves med [Hugo](https://gohugo.io/). *Den kan findes her [blog.jehaj.dk](https://blog.jehaj.dk/)* (ikke længere :/Denne post er til for at hjælpe med at sætte sådant et projekt op - nok mest for fremtidige mig.
